...
public class HiConstants {
	 ...
	 * 存放发送图片的目录
	 */
	public static String HI_PICTURE_PATH = Environment.getExternalStorageDirectory()	+ "/hi/image/";
	
	/**
	 * 我的头像保存目录
	 */
	public static String MyAvatarDir = "/sdcard/hi/avatar/";
	/**
	 * 拍照回调
	 */
